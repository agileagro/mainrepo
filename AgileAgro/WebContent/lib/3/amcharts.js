                ...
                for (g in f)
                    if (f.hasOwnProperty(g)) {
                        ...
                        if (k.includeInMinMax && (!k.hidden || this.includeHidden)) {
                            ...
                            var l;
                            if (this.minMaxField) l = k[this.minMaxField], l < c && (c = l), l > e && (e =
                                l);
                            else
    ...
    d.RecItem = d.Class({
        construct: function(a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            if ("H" == Oa) {
                ...
                v += r / 2;
                "right" == ea ? (G += va + Aa + da, v += ma, I ? (f || (v -= r / 2 + 3), G = G - (B + 4) - Z) : (G += B + 4 + u, v -= 2, G += Z)) : I ? (G += B + 4 - da, f || (v -= r / 2 + 3), g && (G += va, v += ma), G += Z) : (G += -B - u - 4 - 2 - da, v -= 2, G -= Z);
                fa && ("right" == ea ? (na += va + da + Aa - 1, Y += ma, na = I ? na - u : na + u) : (na -= da, I || (na -= B + u)));
                f && (v += f);
                I = -3;
                "right" == ea && (I += ma);
        ...
        createSerialGraph: function() {
            ...
            for (L = Q; L <= ia; L++) {
                ...
                if (Ia) {
                    ...
                    if (!Bb && W < ta || Bb && W < Ba) v.isNegative = !0, Qa && (Ma = Qa), Za && (Va = Za), void 0 != Ja && (Ha = Ja);
                    $a = !1;
                    ...
                    switch (g) {
                        ...
                        case "step":
                            if (!isNaN(W)) {
                                ...
                                if (1 >= this.periodSpan || 1 < this.periodSpan && E - A > ya + Ga) A = z = NaN;
                                this.drawLineGraph(y, u, U, V);
                                y = [];
                                u = [];
                                U = [];
                        ...
                        case "column":
                            ...
                            if (!isNaN(W)) {
                                ...
                                if (!(W < Pb && ob < Pb || W > Qb && ob > Qb)) {
                                    var za;
                                    if (t) {
                                        "3d" == O ? (P = F - (r / 2 - this.depthCount + 1) * (k + T) + T / 2 + S * ea, R = N + H * ea, za = ea) : (P = Math.floor(F - (r / 2 - ea) * (k + T) + T / 2), R = N, za = 0);
                                        K = k;
                                        wa = E;
                                        Ea = P + k / 2;
                                        ka = E;
                                        ...
                                        K = d.roundTo(K, 2);
                                        aa = d.roundTo(aa, 2);
                                        P < q && 0 < K && (ua = new d.Cuboid(h, aa, K, H - a.d3x, S - a.d3y, Ma, Va, ca, Ca, X, ga, w, t, da, bb, mb, Z), v.columnWidth = Math.abs(aa), v.columnHeight = Math.abs(K))
                                    } else {
                                        "3d" == O ? (R = E - (r / 2 - this.depthCount + 1) * (k + T) + T / 2 + H * ea, P = M + S * ea, za = ea) : (R = E - (r / 2 - ea) * (k + T) + T / 2, P = M, za = 0);
                                        K = k;
                                        wa = R + k / 2;
                                        Ea = F;
                                        ka = R + k / 2;
                                        ...
                                        aa += fc - P;
                                        aa = d.fitToBounds(aa, -P + S * za, q - P);
                                        isNaN(G.percentWidthValue) || (K = this.width * G.percentWidthValue / 100, R = ja - K / 2, wa = R + K / 2);
                                        K = d.roundTo(K, 2);
                                        aa = d.roundTo(aa, 2);
                                        R < n + ea * H && 0 < K && (this.showOnAxis && (P -= S / 2), ua = new d.Cuboid(h, K, aa, H - a.d3x, S - a.d3y, Ma, Va, ca, Ca, this.lineAlpha, ga, w, t, da, bb, mb, Z), v.columnHeight = Math.abs(aa), v.columnWidth = Math.abs(K))
                                    }
                                }
                                if (ua) {
                                    xa = ua.set;
                                    ...
                                    if (!I) {
                                        ...
                                        "3d" == O && (t ? (J = (this.end + 1 - L) * C - c - 1E3 * this.depthCount, wa += H * this.columnIndex, ka += H * this.columnIndex, v.y += H * this.columnIndex) : (J = (C - c) * (L + 1) + 1E3 * this.depthCount, Ea += S * this.columnIndex, la += S * this.columnIndex, v.y += S * this.columnIndex));
                            ...
                            if (!isNaN(ta) && !isNaN(W)) {
                                ...
                                if (t) {
                                    ...
                                    if (P < q && 0 < K) {
                                        ...
                                        !isNaN(ra) && !isNaN(pa) && F < q && 0 < F && (Xa = d.line(h, Db, [F, F], Ca, X, ca), cb = d.line(h, Eb, [F, F], Ca, X, ca));
                                        aa = E - N;
                                        ua = new d.Cuboid(h, aa, K, H, S, Ma, Ya, ca, Ca, X, ga, w, t, da, bb, mb, Z)
                                    }
                                } else {
                                    "open" == l && (la = M);
                                    "high" == l && (la = sa);
                                    ...
                                    if (R < n && 0 < K) {
                                        Bb && W >= ta && (Va = 0);
                                        var ua = new d.Cuboid(h, K, aa, H, S, Ma, Va, ca, Ca, X, ga, w, t, da, bb, mb, Z),
                                            Fb, Gb;
                                        W > ta ? (Fb = [F, sa], Gb = [M, qa]) : (Fb = [M, sa], Gb = [F, qa]);
                                        !isNaN(sa) && !isNaN(qa) && E < n && 0 < E && (Xa = d.line(h, [E, E], Fb, Ca, X, ca), cb = d.line(h, [E, E], Gb, Ca, X, ca), d.setCN(a, Xa, this.bcn + "line-high"), v.className && d.setCN(a, Xa, v.className, !0), d.setCN(a, cb, this.bcn + "line-low"), v.className && d.setCN(a, cb, v.className, !0))
                                    }
                                }
                                ua && (xa = ua.set, v.columnGraphics = xa, fa.push(xa), xa.translate(R, P - ca / 2), (v.url || this.showHandOnHover) && xa.setAttr("cursor", "pointer"), Xa && (fa.push(Xa), fa.push(cb)), I || (v.x = t ? P + K / 2 : R + K / 2, this.animateColumns(ua, L, E, N, F, M), this.addListeners(xa, v), void 0 !== this.tabIndex && xa.setAttr("tabindex", this.tabIndex)))
                            }
                            break;
                        case "ohlc":
        ...
        draw: function() {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    this.drop ? (g = C / 1.6, l = 0, "V" == y && (y = "down"), "H" == y && (y = "left"), "down" == y && (D = a + 1, z = b - g - g / 3), "up" == y && (l = 180, D = a + 1, z = b + g + g / 3), "left" == y && (l = 270, D = a + g + g / 3 + 2, z = b), "right" == y && (l = 90, D = a - g - g / 3 + 2, z = b), k = z - H / 2 + 1, m = D - J / 2 - 1, q = d.drop(h, g, l, q, w, r, p, Z)) : 0 < u || 0 === x ? (0 < O && (a = d.rect(h, C, A, q, 0, r + 1, Q, O, u), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), q = d.rect(h, C, A, q, w, r, p, Z, u)) : (t = [], u = [], "H" != y ? (g = a - D, g > C - x && (g = C - x), g < x && (g = x), t = [0, g - x, a - D, g + x, C, C, 0, 0], u = S ? [0, 0, b - z, 0, 0, A, A, 0] : [A, A, b - z, A, A, 0, 0, A]) : (y = b - z, y > A - x && (y = A - x), y < x && (y = x), u = [0, y - x, b - z, y + x, A, A, 0, 0], t = a < g + (l - g) / 2 ? [0, 0, D < a ? 0 : a - D, 0, 0, C, C, 0] : [C, C, D + C > a ? C : a - D, C, C, 0, 0, C]), 0 < O && (a = d.polygon(h, t, u, q, 0, r, Q, O), a.translate(1, 1), f.push(a)), q = d.polygon(h, t, u, q, w, r, p, Z));
                    this.bg = q;
                    f.push(q);
                    q.toFront();
